"""
Django settings for gismodule project.
...
WSGI_APPLICATION = 'gismodule.wsgi.application'
...
MAX_TRANSPORT_ROUTE_OFF_DISTANCE=10000000000
MAX_PASSENGER_ROUTE_OFF_DISTANCE=50